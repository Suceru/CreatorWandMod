...
// Type: CreatorModAPI.TwoPointLineDialog
...
/*两点连线*/
/*namespace CreatorModAPI-=  public class TwoPointLineDialog : InterfaceDialog*/
using Engine;
using Game;
    ...
    public class TwoPointLineDialog : InterfaceDialog
    {
        ...
        public override void Update()
        {
            ...
            Task.Run(() =>
           {
               ...
               foreach (Point3 point3 in creatorAPI.creatorGenerationAlgorithm.TwoPointLineGeneration(creatorAPI.Position[0], creatorAPI.Position[1]))
               {
